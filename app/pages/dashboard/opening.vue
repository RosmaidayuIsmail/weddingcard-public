        ...
        <div class="flex-1 flex flex-col lg:flex-row gap-8 xl:gap-12 lg:min-h-0">
            ...
            <div class="space-y-8 form-panel animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                  <button
                    v-for="(opt, idx) in openingStyles"
                    :key="opt.value"
                    type="button"
                    class="ornament-card group"
                    :class="{ 
                      'ornament-card-active': form.openingStyle === opt.value,
                      'col-span-2': idx === 4 /* Makes the 5th option stretch across both columns elegantly */
                    }"
              ...
              <div class="pt-6 border-t border-gray-800">
                ...
                <div class="space-y-4">
                  ...
                  <UFormField label="Guest Greeting (Prefix)">
                    <UInput v-model="form.openingGreeting" placeholder="e.g. Kepada" size="lg" class="w-full" />
                    <template #help><span class="text-xs text-gray-500">Appears right before the guest's name.</span></template>
                  </UFormField>
          ...
          <div class="w-full lg:w-[360px] xl:w-[400px] shrink-0 flex flex-col items-center pb-8 lg:pb-0 overflow-y-auto hide-scrollbar order-1 lg:order-2">
            <div class="flex items-center justify-between w-full mb-4 px-2">
              ...
              <UButton variant="link" color="gray" size="xs" icon="i-heroicons-arrow-path" @click="previewOpened = false" padded={false}>
                Reset Preview
              </UButton>
            </div>
