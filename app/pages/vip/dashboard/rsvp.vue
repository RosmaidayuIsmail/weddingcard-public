<template>
  <div class="h-full min-h-screen lg:h-[calc(100vh-6rem)] flex flex-col overflow-x-hidden">
    ...
    <div v-else-if="!wedding" class="flex flex-col items-center justify-center flex-1 text-white/60 space-y-6">
      ...
      <p class="text-lg">Set up your wedding details first.</p>
      <UButton to="/vip/dashboard" size="lg" color="primary" class="font-semibold shadow-lg shadow-gold-500/20">Go to Wedding Details</UButton>
    </div>
...
useSeoMeta({ title: 'RSVP Text — VIP Cinematic' })
</script>
