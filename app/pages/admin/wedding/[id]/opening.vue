          ...
          <div class="flex-1 w-full lg:overflow-y-auto custom-scrollbar lg:pr-6 pb-8 lg:pb-20 space-y-8 order-2 lg:order-1">
            ...
            <div class="space-y-8 form-panel animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <!-- Page Layout - Classic (today's Opening -> Details -> RSVP
                   ...
                   invitation the client asked to match). Everything below
                   this card (cover style, palettes, fonts, etc.) still
                   applies to both layouts - this only changes how the
                   content after the cover is presented. VIP Cinematic lives
                   on its own separate page/link (VIP Cinematic nav item)
                   rather than as a layoutStyle option here - see
                   VipScenesPanel.vue. -->
              <div>
