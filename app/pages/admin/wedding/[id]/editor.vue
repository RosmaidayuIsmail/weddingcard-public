<template>
        ...
        <div class="flex-1 flex flex-col lg:flex-row gap-8 xl:gap-12 lg:min-h-0">
          ...
          <div class="flex-1 w-full pb-8 space-y-8 order-2 lg:order-1">
            ...
            <div v-if="activeSection === 'couple'" class="space-y-6 form-panel animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <div class="p-4 rounded-xl bg-[#111827] border border-gray-700">
                ...
                <p class="text-xs text-white/50 mb-3">
                  ...
                  <NuxtLink :to="`/admin/wedding/${weddingId}/guests`" class="underline hover:text-gold-300">Guest List</NuxtLink> page.
                </p>
            ...
            <div v-if="activeSection === 'event'" class="space-y-6 form-panel animate-in fade-in slide-in-from-bottom-4 duration-500">
              ...
              <!-- Details/Location page text - language presets. These are
                   the section headings/labels guests see on the live Details
                   page ("The Details", "Bride & Groom", "Location", the Maps
                   button, etc.) - previously hardcoded in English regardless
                   of the couple's own language, now editable per-field with
                   one-tap English/Malay presets, same pattern as the RSVP
                   editor. -->
            ...
            <div v-if="activeSection === 'photo'" class="space-y-6 form-panel animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div class="panel-header">
                ...
                <p class="text-xs text-indigo-300/80 mt-1 flex items-center gap-1">
                  ...
                  <NuxtLink :to="`/admin/wedding/${weddingId}/opening`" class="underline hover:text-indigo-200">Opening Design</NuxtLink> page.
                </p>
              </div>
  ...
  // into it going forward - the EN/Bahasa Melayu buttons below let an admin
  ...
  useSeoMeta({ title: 'Design Studio (Admin) — WeddingCard', robots: 'noindex, nofollow' })
  </script>
