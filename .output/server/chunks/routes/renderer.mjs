...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Build a beautiful digital and printable wedding invitation, manage VIP and general guest lists, plan your wedding-day flow, and track RSVPs live."},{"name":"theme-color","content":"#04101f"},{"property":"og:type","content":"website"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"data:image/svg+xml,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\"><text y=\".9em\" font-size=\"90\">💍</text></svg>"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"en"},"title":"WeddingCard — Design your wedding invitation & manage RSVPs"};
